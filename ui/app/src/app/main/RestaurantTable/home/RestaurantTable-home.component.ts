...
@Component({
  selector: 'RestaurantTable-home',
  templateUrl: './RestaurantTable-home.component.html',
  styleUrls: ['./RestaurantTable-home.component.scss']
})
export class RestaurantTableHomeComponent implements AfterViewInit {
