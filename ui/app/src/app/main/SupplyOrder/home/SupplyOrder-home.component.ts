...
@Component({
  selector: 'SupplyOrder-home',
  templateUrl: './SupplyOrder-home.component.html',
  styleUrls: ['./SupplyOrder-home.component.scss']
})
export class SupplyOrderHomeComponent implements AfterViewInit {
